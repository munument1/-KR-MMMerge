...
ROW_FIXES: dict[int, list[tuple[str, str]]] = {
    ...
    1304: [("(무기 숙련도 +10, 인격 +40)", "(무기 전문가 기술 +10, 인성 +40)")],
    ...
    # Merge ExtraArtifacts grants Unarmed +5, Disarm Traps +5 and Water Breathing.
    1318: [
        ("도둑질 기술 +5", "맨손 기술 +5"),
        ("훔치기 기술 +5", "맨손 기술 +5"),
        ("물 위 걷기", "수중 호흡"),
    ...
    1319: [("엘프 학살", "엘프 사냥")],
    1323: [("(빛 마법, 인격 +15, 힘 +15, 운 -40, 선함)", "(빛 마법, 인성 +15, 힘 +15, 운 -40, 선)")],
