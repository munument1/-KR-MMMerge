...
FIXES: list[tuple[str, str, str, str]] = [
    ...
    ("mmmerge/Text localization/LANG_ItemsTxt.txt|id=274|field=Notes",
     ...
     "인격 수치를 영구적으로 15만큼 올리고 속도를 5만큼 감소시킵니다. (마시려면 물약을 집어 들고 캐릭터 초상화를 오른쪽 클릭하십시오. 섞으려면 물약을 집어 들고 다른 물약을 오른쪽 클릭하십시오.)",
     "인격 수치를 영구적으로 15만큼 올리고 민첩성을 5만큼 감소시킵니다. (마시려면 물약을 집어 들고 캐릭터 초상화를 오른쪽 클릭하십시오. 섞으려면 물약을 집어 들고 다른 물약을 오른쪽 클릭하십시오.)"),
    ...
    ("mmmerge/Text localization/LANG_ItemsTxt.txt|id=277|field=Notes",
     ...
     "이동 속도를 15만큼 영구적으로 증가시키고 인격을 5만큼 감소시킵니다. (마시려면 물약을 집어 들고 캐릭터 초상화를 오른쪽 클릭하십시오. 섞으려면 물약을 집어 들고 다른 물약을 오른쪽 클릭하십시오.)",
     "민첩성을 15만큼 영구적으로 증가시키고 인격을 5만큼 감소시킵니다. (마시려면 물약을 집어 들고 캐릭터 초상화를 오른쪽 클릭하십시오. 섞으려면 물약을 집어 들고 다른 물약을 오른쪽 클릭하십시오.)"),
