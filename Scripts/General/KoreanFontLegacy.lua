-- Emergency fallback only.  The native direct-blit renderer in FNT_DBCS.lua
-- owns the MM8 text hooks whenever it installed successfully.
if DBCS and DBCS.NativeInstalled then
    return
end
