...
- Applies safe source tables before Merge creates NPC/news/travel caches.
- Applies the complete localization again after base initialization.
- Repairs English copies retained in map news, continent news, profession news, NPC topics, greetings, and town portal descriptions.
- Keeps NPCNews untouched during the early pass so Merge can safely read each row's embedded topic string.
- Writes exact runtime and derived-cache comparison results to Data\KO_LocalizationValidation.log.
